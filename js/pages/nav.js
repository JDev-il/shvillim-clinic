...
{/* <a class="navbar-brand" href="../home.html">שבילים</a>
<button
...
<div class="collapse navbar-collapse" id="navbarNav">
  <ul class="navbar-nav">
    ...
    <li class="nav-item" id="2">
      <a class="nav-link" href="./tonylaviad.html">ד"ר טוני לביאד</a>
    </li>
    <li class="nav-item dropdown" id="dropdownCat">
      <a class="nav-link">מאמרים מקצועיים</a>
      <div class="dropdown-menu">
    ...
    <li class="nav-item dropdown active" id="dropdownCat">
      <a class="nav-link">סוגי טיפולים</a>
      <div class="dropdown-menu">
        <a class="dropdown-item active" href="./panic.html" id="6"
        >הפרעות חרדה</a
      >
...
//! FROM HERE >> Dynamic Navigation via JS
